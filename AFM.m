...
% % x_interior=[1.25 1.75 1.75 1.25 1.25];
...
% plot(int_node_x,int_node_y,'.')
% plot(x_internal,y_internal)
% plot(x_exterior , y_exterior)
% 
% 
% axis equal
% if numel(x_internal)>0
% legend("","Intersection of horizontal Line with the domain","Interior Nodes","Pit")
% else
